...
import 'package:hellonong/model/thigh_sym.dart';
import 'package:hellonong/widget/bottomNavi.dart';

import '../home.dart';

class Picture_pelvis extends StatefulWidget {
  const Picture_pelvis({Key? key}) : super(key: key);

  @override
  State<Picture_pelvis> createState() => _Picture_pelvisState();
}
...
class _Picture_pelvisState extends State<Picture_pelvis> {
  ...
  List<Widget> _buildGridCards(BuildContext context) {
    List<Product> products = ProductsRepository.loadProducts(Category.thigh);
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    AspectRatio(
                      ...
                      child: Image.asset(
                        //fit: BoxFit.fitWidth,
                        'assets/images/sym/pelvis/${product.id}.png', // 이미지 가져오기
                      ),
                    ),
                  ],
                ),
