...
class Picture_organ extends StatefulWidget {
  const Picture_organ({Key? key}) : super(key: key);

  @override
  State<Picture_organ> createState() => _Picture_organState();
}
...
class _Picture_organState extends State<Picture_organ> {
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    AspectRatio(
                      ...
                      child: Image.asset(
                        //fit: BoxFit.fitWidth,
                        'assets/images/sym/organ/${product.id}.png', // 이미지 가져오기
                      ),
                    ),
                  ],
                ),
