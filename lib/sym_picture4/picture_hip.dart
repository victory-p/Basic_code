...
class Picture_hip extends StatefulWidget {
  const Picture_hip({Key? key}) : super(key: key);

  @override
  State<Picture_hip> createState() => _Picture_hipState();
}
...
class _Picture_hipState extends State<Picture_hip> {
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    AspectRatio(
                      ...
                      child: Image.asset(
                        //fit: BoxFit.fitWidth,
                        'assets/images/sym/hip/${product.id}.png', // 이미지 가져오기
                      ),
                    ),
                  ],
                ),
