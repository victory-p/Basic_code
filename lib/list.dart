...
import 'package:hellonong/opinion.dart'; // 수정
          ...
          Navigator.push(
            ...
            MaterialPageRoute(
              builder: (context) => Opinion(
                ...
                onAddItem: (item) {
                  // Opinion 페이지에서 항목 추가 시 처리
                  setState(() {
                    checkboxText.add(item);
                    isSelected.add(true);
                  });
                },
                onRemoveItem: (item) {
                  // Opinion 페이지에서 항목 제거 시 처리
                  setState(() {
                    int itemIndex = checkboxText.indexOf(item);
                    if (itemIndex != -1) {
                      checkboxText.removeAt(itemIndex);
                      isSelected.removeAt(itemIndex);
                    }
                  });
                },
              ),
