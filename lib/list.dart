...
import 'package:hellonong/listtwo.dart'; // 수정된 부분: import 추가
...
class _ListWidgetState extends State<ListWidget> {
          ...
          Navigator.push(
            ...
            MaterialPageRoute(
              builder: (context) => Opinion(
                ...
                onAddItem: _addItemToOpinion,
                onRemoveItem: _removeItemFromOpinion,
              ),
            ),
          );
        },
  ...
  // Function to add item to opinion list
  void _addItemToOpinion(String item) {
    setState(() {
      checkedItems.add(item);
    });
  }

  // Function to remove item from opinion list
  void _removeItemFromOpinion(String item) {
    setState(() {
