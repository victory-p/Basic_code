...
class Picture_chest extends StatefulWidget {
  const Picture_chest({Key? key}) : super(key: key);

  @override
  State<Picture_chest> createState() => _Picture_chestState();
}
...
class _Picture_chestState extends State<Picture_chest> {
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    AspectRatio(
                      ...
                      child: Image.asset(
                        //fit: BoxFit.fitWidth,
                        'assets/images/sym/chest/${product.id}.png', // 이미지 가져오기
                      ),
                    ),
                  ],
                ),
