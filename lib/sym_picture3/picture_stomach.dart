...
class Picture_stomach extends StatefulWidget {
  const Picture_stomach({Key? key}) : super(key: key);

  @override
  State<Picture_stomach> createState() => _Picture_stomachState();
}
...
class _Picture_stomachState extends State<Picture_stomach> {
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    AspectRatio(
                      ...
                      child: Image.asset(
                        //fit: BoxFit.fitWidth,
                        'assets/images/sym/stomach/${product.id}.png', // 이미지 가져오기
                      ),
                    ),
                  ],
                ),
