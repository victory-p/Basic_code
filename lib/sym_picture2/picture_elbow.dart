...
class Picture_elbow extends StatefulWidget {
  const Picture_elbow({Key? key}) : super(key: key);

  @override
  State<Picture_elbow> createState() => _Picture_elbowState();
}
...
class _Picture_elbowState extends State<Picture_elbow> {
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    AspectRatio(
                      ...
                      child: Image.asset(
                        //fit: BoxFit.fitWidth,
                        'assets/images/sym/elbow/${product.id}.png', // 이미지 가져오기
                      ),
                    ),
                  ],
                ),
