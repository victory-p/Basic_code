...
class Picture_wrist extends StatefulWidget {
  const Picture_wrist({Key? key}) : super(key: key);

  @override
  State<Picture_wrist> createState() => _Picture_wristState();
}
...
class _Picture_wristState extends State<Picture_wrist> {
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    AspectRatio(
                      ...
                      child: Image.asset(
                        //fit: BoxFit.fitWidth,
                        'assets/images/sym/wrist/${product.id}.png', // 이미지 가져오기
                      ),
                    ),
                  ],
                ),
