...
class Picture_hand extends StatefulWidget {
  const Picture_hand({Key? key}) : super(key: key);

  @override
  State<Picture_hand> createState() => _Picture_handState();
}
...
class _Picture_handState extends State<Picture_hand> {
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    AspectRatio(
                      ...
                      child: Image.asset(
                        //fit: BoxFit.fitWidth,
                        'assets/images/sym/hand/${product.id}.png', // 이미지 가져오기
                      ),
                    ),
                  ],
                ),
