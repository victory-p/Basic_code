...
class Picture_knee extends StatefulWidget {
  const Picture_knee({Key? key}) : super(key: key);

  @override
  State<Picture_knee> createState() => _Picture_kneeState();
}
...
class _Picture_kneeState extends State<Picture_knee> {
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    AspectRatio(
                      ...
                      child: Image.asset(
                        //fit: BoxFit.fitWidth,
                        'assets/images/sym/knee/${product.id}.png', // 이미지 가져오기
                      ),
                    ),
                  ],
                ),
