...
class Picture_foot extends StatefulWidget {
  const Picture_foot({Key? key}) : super(key: key);

  @override
  State<Picture_foot> createState() => _Picture_footState();
}
...
class _Picture_footState extends State<Picture_foot> {
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    AspectRatio(
                      ...
                      child: Image.asset(
                        //fit: BoxFit.fitWidth,
                        'assets/images/sym/foot/${product.id}.png', // 이미지 가져오기
                      ),
                    ),
                  ],
                ),
