...
class Picture_ankle extends StatefulWidget {
  const Picture_ankle({Key? key}) : super(key: key);

  @override
  State<Picture_ankle> createState() => _Picture_ankleState();
}
...
class _Picture_ankleState extends State<Picture_ankle> {
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    AspectRatio(
                      ...
                      child: Image.asset(
                        //fit: BoxFit.fitWidth,
                        'assets/images/sym/ankle/${product.id}.png', // 이미지 가져오기
                      ),
                    ),
                  ],
                ),
