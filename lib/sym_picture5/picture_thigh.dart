...
class Picture_thigh extends StatefulWidget {
  const Picture_thigh({Key? key}) : super(key: key);

  @override
  State<Picture_thigh> createState() => _Picture_thighState();
}
...
class _Picture_thighState extends State<Picture_thigh> {
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    AspectRatio(
                      ...
                      child: Image.asset(
                        //fit: BoxFit.fitWidth,
                        'assets/images/sym/thigh/${product.id}.png', // 이미지 가져오기
                      ),
                    ),
                  ],
                ),
