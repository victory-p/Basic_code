...
class Picture_neck extends StatefulWidget {
  const Picture_neck({Key? key}) : super(key: key);

  @override
  State<Picture_neck> createState() => _Picture_neckState();
}
...
class _Picture_neckState extends State<Picture_neck> {
  ...
  List<Widget> _buildGridCards(BuildContext context) {
    ...
    List<Product> filteredProducts = products.where((product) => product.id.startsWith('6-')).toList();
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    AspectRatio(
                      ...
                      child: Image.asset(
                        //fit: BoxFit.fitWidth,
                        'assets/images/sym/neck/${product.id}.png', // 이미지 가져오기
                      ),
                    ),
                  ],
                ),
