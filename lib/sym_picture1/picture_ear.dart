...
class Picture_ear extends StatefulWidget {
  const Picture_ear({Key? key}) : super(key: key);

  @override
  State<Picture_ear> createState() => _Picture_earState();
}
...
class _Picture_earState extends State<Picture_ear> {
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    AspectRatio(
                      ...
                      child: Image.asset(
                        //fit: BoxFit.fitWidth,
                        'assets/images/sym/ear/${product.id}.png', // 이미지 가져오기
                      ),
                    ),
                  ],
                ),
