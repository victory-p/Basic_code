...
class Picture_teeth extends StatefulWidget {
  const Picture_teeth({Key? key}) : super(key: key);

  @override
  State<Picture_teeth> createState() => _Picture_teethState();
}
...
class _Picture_teethState extends State<Picture_teeth> {
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    AspectRatio(
                      ...
                      child: Image.asset(
                        //fit: BoxFit.fitWidth,
                        'assets/images/sym/teeth/${product.id}.png', // 이미지 가져오기
                      ),
                    ),
                  ],
                ),
