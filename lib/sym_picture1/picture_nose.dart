...
class Picture_nose extends StatefulWidget {
  const Picture_nose({Key? key}) : super(key: key);

  @override
  State<Picture_nose> createState() => _Picture_noseState();
}
...
class _Picture_noseState extends State<Picture_nose> {
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    AspectRatio(
                      ...
                      child: Image.asset(
                        //fit: BoxFit.fitWidth,
                        'assets/images/sym/nose/${product.id}.png', // 이미지 가져오기
                      ),
                    ),
                  ],
                ),
